...
namespace ipo2_pokedex
{
    public sealed partial class PiplupMLTN : UserControl, iPokemon
    {
        ...
        public async Task AnimaAtaqFlojo_AuxAsync()
        {
            ...
            mpSonidos2.Source = MediaSource.CreateFromUri(new Uri("ms-appx:///Assets/pokemons/PiplupMLTN/sonido_surf.mp3"));
            mpSonidos2.Play();
        ...
        public async Task AnimaAtaqFuerte_AuxAsync()
        {
            ...
            mpSonidos.Source = MediaSource.CreateFromUri(new Uri("ms-appx:///Assets/pokemons/PiplupMLTN/sonido_frioPolar.mp3"));
            mpSonidos.Play();
            await Task.Delay(200);
        ...
        public async Task AnimaDefensa_AuxAsync()
        {
            ...
            mpSonidos3.Source = MediaSource.CreateFromUri(new Uri("ms-appx:///Assets/pokemons/PiplupMLTN/sonido_escudo.mp3"));
            mpSonidos3.Play();
        ...
        public async Task AnimaDescansar_AuxAsync()
        {
            ...
            mpSonidos7.Source = MediaSource.CreateFromUri(new Uri("ms-appx:///Assets/pokemons/PiplupMLTN/sonido_descanso.mp3"));
            mpSonidos7.Play();
        ...
        public async Task AnimaCansado_AuxAsync()
        {
            ...
            mpSonidos4.Source = MediaSource.CreateFromUri(new Uri("ms-appx:///Assets/pokemons/PiplupMLTN/sonido_cansado.mp3"));
            mpSonidos4.Play();
        ...
        public async Task AnimaHerido_AuxAsync()
        {
            Storyboard anima;
            MediaPlayer mpSonidos4 = new MediaPlayer();
            mpSonidos4.Source = MediaSource.CreateFromUri(new Uri("ms-appx:///Assets/pokemons/PiplupMLTN/sonido_herir.m4a"));
            mpSonidos4.Play();
        ...
        public async Task AnimaDerrota_AuxAsync()
        {
            Storyboard anima;
            MediaPlayer mpSonidos4 = new MediaPlayer();
            mpSonidos4.Source = MediaSource.CreateFromUri(new Uri("ms-appx:///Assets/pokemons/PiplupMLTN/sonido_derrotado.mp3"));
            mpSonidos4.Play();
