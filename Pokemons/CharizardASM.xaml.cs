...
namespace ipo2_pokedex
{
    public sealed partial class CharizardASM : UserControl, iPokemon
    {
        ...
        private void clickNumber(object sender, KeyRoutedEventArgs e)
        {
            ...
            switch (e.Key)
            {
                ...
                case Windows.System.VirtualKey.Number2: // Key 2
                    if (!evolution)
                    {
                        this.PlayAudio("ms-appx:///Assets/pokemons/CharizardASM/audios/evolucion.mp3");
                ...
                case Windows.System.VirtualKey.Number3: // Key 3
                    ...
                    this.PlayAudio("ms-appx:///Assets/pokemons/CharizardASM/audios/garra.mp3");
                    break;
                case Windows.System.VirtualKey.Number4: // Key 4
                    this.checkEvolution();
                    this.StartAnimation("sb_lanza_llamas");
                    this.PlayAudio("ms-appx:///Assets/pokemons/CharizardASM/audios/lanzallamas.mp3");
                    break;
                ...
                case Windows.System.VirtualKey.Number6: // Key 6
                    this.PlayAudio("ms-appx:///Assets/pokemons/CharizardASM/audios/recuperado.mp3");
                ...
                case Windows.System.VirtualKey.Number7: // Key 7
                    this.checkEvolution();
                    this.PlayAudio("ms-appx:///Assets/pokemons/CharizardASM/audios/mewing.mp3");
        ...
        private void checkEvolution()
        {
            ...
            if (evolution)
            {
                mano_mewing.Source = new BitmapImage(new Uri("ms-appx:///Assets/pokemons/CharizardASM/mano_mewing_black.png"));
                lanzallamas.Source = new BitmapImage(new Uri("ms-appx:///Assets/pokemons/CharizardASM/lanzallamas_azul.png"));
                cara_mewing.Source = new BitmapImage(new Uri("ms-appx:///Assets/pokemons/CharizardASM/mewing_black.png"));
            }
            else
            {
                mano_mewing.Source = new BitmapImage(new Uri("ms-appx:///Assets/pokemons/CharizardASM/mano_mewing.png"));
                lanzallamas.Source = new BitmapImage(new Uri("ms-appx:///Assets/pokemons/CharizardASM/lanzallamas.png"));
                cara_mewing.Source = new BitmapImage(new Uri("ms-appx:///Assets/pokemons/CharizardASM/mewing.png"));
            }
        }
        ...
        private void blue_potion_PointerReleased(object sender, PointerRoutedEventArgs e)
        {
            if (!this.derrotado)
            {
                this.checkEvolution();
        ...
        public void verFondo(bool ver)
        {
            if (ver)
            {
                this.background.Visibility = Visibility.Collapsed;
            }
            else
            {
                this.background.Visibility = Visibility.Collapsed;
        ...
        public void verFilaVida(bool ver)
        {
            ...
            if (ver)
            {
                ...
                this.i_heart.Visibility = Visibility.Visible;
                this.green_potion.Visibility = Visibility.Visible;
            }
            else
            {
                pb_heal.Visibility = Visibility.Collapsed;
                this.i_heart.Visibility = Visibility.Collapsed;
                this.green_potion.Visibility = Visibility.Collapsed;
            }
        }
        ...
        public void verFilaEnergia(bool ver)
        {
            ...
            if (ver)
            {
                ...
                this.i_shield.Visibility = Visibility.Visible;
                this.blue_potion.Visibility = Visibility.Visible;
            }
            else
            {
                pb_energy.Visibility = Visibility.Collapsed;
                this.i_shield.Visibility = Visibility.Collapsed;
                this.blue_potion.Visibility = Visibility.Collapsed;
            }
        }
        ...
        {
            this.PlayAudio("ms-appx:///Assets/pokemons/pokemons/CharizardASM/audios/recuperado.mp3");
            this.StartAnimation("sb_levantar");
            derrotado = false;
