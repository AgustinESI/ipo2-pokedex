...
namespace PokemonNoelia
{
    public sealed partial class ChandelureNDAA : UserControl, iPokemon
    {
        ...
        private void usePotionRed(object sender, PointerRoutedEventArgs e)
        {
            ...
            dtTime.Start();
            imPocionMorada.Visibility=Visibility.Collapsed;
        }
        ...
        public void activarAniIdle(bool activar)
        {
            if (activar)
            {
                sbaux = (Storyboard)this.Resources["Vuelo"];
                sbaux.Begin();
                mpSonidos.Source = MediaSource.CreateFromUri(new Uri("ms-appx:////Assets/pokemons/ChandelureNDAA/Normal.mp4"));
                mpSonidos.Play();
            }
            else sbaux.Stop();
        }
        ...
        public void animacionAtaqueFlojo()
        {
            sbaux = (Storyboard)this.Resources["AtaqueDebil"];
            sbaux.Begin();
            mpSonidos.Source = MediaSource.CreateFromUri(new Uri("ms-appx:///Assets/pokemons/ChandelureNDAA/AtaqueDebilSonido.mp3"));
            mpSonidos.Play();
        }
        ...
        public void animacionAtaqueFuerte()
        {
            sbaux = (Storyboard)this.Resources["AtaqueFuerte"];
            sbaux.Begin();
            mpSonidos.Source = MediaSource.CreateFromUri(new Uri("ms-appx:///Assets/pokemons/ChandelureNDAA/AtaqueFuerteSonido.mp4"));
            mpSonidos.Play();
        }
        ...
        public void animacionCansado()
        {
            sbaux = (Storyboard)this.Resources["Cansado"];
            sbaux.Begin();
            mpSonidos.Source = MediaSource.CreateFromUri(new Uri("ms-appx:///Assets/pokemons/ChandelureNDAA/CansadoSonido.mp4"));
            mpSonidos.Play();
        }
        ...
        public void animacionDefensa()
        {
            sbaux = (Storyboard)this.Resources["Defensa"];
            sbaux.Begin();
            mpSonidos.Source = MediaSource.CreateFromUri(new Uri("ms-appx:///Assets/pokemons/ChandelureNDAA/VueloSonido.mp4"));
            mpSonidos.Play();
        }
        ...
        public void animacionDerrota()
        {
            sbaux = (Storyboard)this.Resources["Muerte"];
            sbaux.Begin();
            mpSonidos.Source = MediaSource.CreateFromUri(new Uri("ms-appx:///Assets/pokemons/ChandelureNDAA/MuerteSonido.mp4"));
            mpSonidos.Play();
        }
        ...
        public void animacionDescasar()
        {
            sbaux = (Storyboard)this.Resources["MovVida"];
            sbaux.Begin();
            mpSonidos.Source = MediaSource.CreateFromUri(new Uri("ms-appx:///Assets/pokemons/ChandelureNDAA/VidaSonidoFeliz.mp4"));
            mpSonidos.Play();
        }
        ...
        {
            sbaux = (Storyboard)this.Resources["Herido"];
            mpSonidos.Source = MediaSource.CreateFromUri(new Uri("ms-appx:///Assets/pokemons/ChandelureNDAA/HeridoSonido.mp4"));
            mpSonidos.Play();
            sbaux.Begin();
        }
        ...
        public void verFondo(bool ver)
        {
            ...
            {
                this.imFondo.ImageSource = new BitmapImage(new Uri("/Assets/pokemons/ChandelureNDAA/fondo.png", UriKind.Relative));
            }
        ...
        public void verPocionEnergia(bool ver)
        {
            if (!ver)
            {
                this.imPocionAmarilla.Visibility=Visibility.Collapsed;
            }
            else
            {
                this.imPocionAmarilla.Source = new BitmapImage(new Uri("/Assets/pokemons/ChandelureNDAA/pocionAmarilla.png", UriKind.Relative));
            }
        }
        ...
        public void verPocionVida(bool ver)
        {
            ...
            {
                imPocionMorada.Source = new BitmapImage(new Uri("/Assets/pokemons/ChandelureNDAA/pocionMorada.png", UriKind.Relative));
            }
        }
    }
}
