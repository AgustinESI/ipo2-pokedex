...
namespace ipo2_pokedex
{
    public sealed partial class MakuhitaAPQ : UserControl, iPokemon
    {
        ...
        public void animacionDerrota()
        {
            ...
            sbMov.Stop();
            mpSonidos.Source = MediaSource.CreateFromUri(new Uri("ms-appx:///Assets/pokemons/MakuhitaAPQ/SonidoDerrotado.mp3"));
            mpSonidos.Play();
        ...
        public void animacionEscudo()
        {
            ...
            sbMov.Stop();
            mpSonidos.Source = MediaSource.CreateFromUri(new Uri("ms-appx:///Assets/pokemons/MakuhitaAPQ/SonidoEscudo.mp3"));
            mpSonidos.Play();
            dtTime = new DispatcherTimer();
