...
{
    public sealed partial class LaprasACE : UserControl, iPokemon
    {
        ...
        public void animacionAtaqueFlojo()
        {
            ...
            this.sonidos.Source = MediaSource.CreateFromUri(new Uri("ms-appx:///Assets/pokemons/LaprasACE/Sounds/AtaqueDebil.mp3"));
        ...
        public void animacionAtaqueFuerte()
        {
            ...
            this.sonidos.Source = MediaSource.CreateFromUri(new Uri("ms-appx:///Assets/pokemons/LaprasACE/Sounds/AtaqueFuerte.mp3"));
            sonidos.MediaPlayer.Play();
        }
        ...
        public void animacionDefensa()
        {
            ...
            this.sonidos.Source = MediaSource.CreateFromUri(new Uri("ms-appx:///Assets/pokemons/LaprasACE/Sounds/Escudo.mp3"));
            sonidos.MediaPlayer.Play();
        }
        ...
        public void animacionDescasar()
        {
            ...
            this.sonidos.Source = MediaSource.CreateFromUri(new Uri("ms-appx:///Assets/pokemons/LaprasACE/Sounds/Descanso.mp3"));
            sonidos.MediaPlayer.Play();
        }
        ...
        public void animacionCansado()
        {
            ...
            this.sonidos.Source = MediaSource.CreateFromUri(new Uri("ms-appx:///Assets/pokemons/LaprasACE/Sounds/Cansado.mp3"));
            sonidos.MediaPlayer.Play();
        ...
        public void animacionNoCansado()
        {
            ...
            this.sonidos.Source = MediaSource.CreateFromUri(new Uri("ms-appx:///Assets/pokemons/LaprasACE/Sounds/QuitarCansado.mp3"));
            sonidos.MediaPlayer.Play();
        ...
        public void animacionHerido()
        {
            ...
            heridoEstado.Begin();
            caraCansadoHerido.Begin();
            this.sonidos.Source = MediaSource.CreateFromUri(new Uri("ms-appx:///Assets/pokemons/LaprasACE/Sounds/PowerDown.mp3"));
            sonidos.MediaPlayer.Play();
        }
        ...
        public void animacionNoHerido()
        {
            ...
            this.sonidos.Source = MediaSource.CreateFromUri(new Uri("ms-appx:///Assets/pokemons/LaprasACE/Sounds/PowerUp.mp3"));
            sonidos.MediaPlayer.Play();
        }
        ...
        {
            muerteEstado.Begin();
            this.sonidos.Source = MediaSource.CreateFromUri(new Uri("ms-appx:///Assets/pokemons/LaprasACE/Sounds/Muerte.mp3"));
            sonidos.MediaPlayer.Play();
        }
