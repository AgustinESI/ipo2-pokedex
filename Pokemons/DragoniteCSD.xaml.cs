...
namespace ipo2_pokedex
{
    public sealed partial class DragoniteCSD : UserControl, iPokemon
    {
        ...
        private void ReproducirAtaqueDespuesEnfado(MediaPlayer sender, object args)
        {
            ...
            mpsonidos.Source = MediaSource.CreateFromUri(new Uri("ms-appx:///Assets/pokemons/DragoniteCSD/Ataque.mp3"));
            mpsonidos.Play();
        }
        ...
        public void verFondo(bool ver)
        {
            ...
            {
                BitmapImage bitmapImage = new BitmapImage(new Uri("ms-appx:///Assets/pokemons/DragoniteCSD/escenariopokemon.jpg"));
        ...
        public void verPocionVida(bool ver)
        {
            ...
            {
                this.img_pocionvida.Source = new BitmapImage(new Uri("ms-appx:///Assets/pokemons/DragoniteCSD/pocionvida.png"));
            }
        }
        ...
        public void verPocionEnergia(bool ver)
        {
            ...
            else
            {
                ...
                this.img_pocionstamina.Source = new BitmapImage(new Uri("ms-appx:///Assets/pokemons/DragoniteCSD/pocionstamina.png"));
            }
        }
        ...
        public void animacionAtaqueFuerte()
        {
            ...
            sb.Begin();
            mpsonidos.Source = MediaSource.CreateFromUri(new Uri("ms-appx:///Assets/pokemons/DragoniteCSD/explosion.wav"));
            dtTime = new DispatcherTimer();
        ...
        public void animacionAtaqueFlojo()
        {
            ...
            sb.Completed += (s, args) => ResetAnimation(cansado, herido);
            mpsonidos.MediaEnded += ReproducirAtaqueDespuesEnfado;
            mpsonidos.Source = MediaSource.CreateFromUri(new Uri("ms-appx:///Assets/pokemons/DragoniteCSD/Enfado.mp3"));
            mpsonidos.Play();
            dtTime = new DispatcherTimer();
        ...
        public void animacionDefensa()
        {
            ...
            sb.Completed += (s, args) => ResetAnimation(cansado, herido);
            sb.Begin();
            mpsonidos.Source = MediaSource.CreateFromUri(new Uri("ms-appx:///Assets/pokemons/DragoniteCSD/escudo.mp3"));
            dtTime = new DispatcherTimer();
            dtTime.Interval = TimeSpan.FromMilliseconds(1300);
            dtTime.Tick += (s, args) =>
            {
        ...
        public void animacionCansado()
        {
            ...
            sb = (Storyboard)this.Resources["Cansado"];
            sb.Completed += (s, args) => ResetAnimation(cansado, herido);
            mpsonidos.Source = MediaSource.CreateFromUri(new Uri("ms-appx:///Assets/pokemons/DragoniteCSD/cansado.mp3"));
            mpsonidos.Play();
            sb.Begin();
            cansado = true;
        }
        ...
        public void animacionHerido()
        {
            ...
            sb = (Storyboard)this.Resources["Herido"];
            sb.Completed += (s, args) => ResetAnimation(cansado, herido);
            mpsonidos.Source = MediaSource.CreateFromUri(new Uri("ms-appx:///Assets/pokemons/DragoniteCSD/herido.mp3"));
            mpsonidos.Play();
            dtTime = new DispatcherTimer();
            dtTime.Interval = TimeSpan.FromMilliseconds(1300);
            dtTime.Tick += (s, args) =>
        ...
        public void animacionDerrota()
        {
            ...
            mpsonidos.Source = MediaSource.CreateFromUri(new Uri("ms-appx:///Assets/pokemons/DragoniteCSD/muertedef.mp3"));
            mpsonidos.Play();
            sb.Begin();
            defaultStoryboard.Stop();
        }
        ...
        public void animacionDescasar()
        {
            ...
            sb.Completed += (s, args) => ResetAnimation(cansado, herido);
            mpsonidos.Source = MediaSource.CreateFromUri(new Uri("ms-appx:///Assets/pokemons/DragoniteCSD/CuraVida.mp3"));
            mpsonidos.Play();
            dtTime = new DispatcherTimer();
