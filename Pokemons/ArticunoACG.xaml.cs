...
namespace ipo2_pokedex
{
    public sealed partial class ArticunoACG : UserControl, iPokemon
    {
        ...
        {
            get => "Articuno es un gran Pokémon legendario aviar con plumaje predominantemente azul y alas que se dice que están hechas de hielo. En su frente hay una cresta que consta de tres plumas azules más oscuras en forma de rombo";
        ...
        public void animacionAtaqueFlojo()
        {
            ...
            auxiliar.Begin();
            mpSonidos.Source = MediaSource.CreateFromUri(new Uri("ms-appx:///Assets/pokemons/ArticunoACG/CabezazoRalentizado.mp3"));
            mpSonidos.Play();
        }
        ...
        public void animacionAtaqueFuerte()
        {
            ...
            auxiliar.Begin();
            mpSonidos.Source = MediaSource.CreateFromUri(new Uri("ms-appx:///Assets/pokemons/ArticunoACG/RayoHielo.mp3"));
            mpSonidos.Play();
        }
        ...
        public void animacionDefensa()
        {
            ...
            auxiliar.Begin();
            mpSonidos.Source = MediaSource.CreateFromUri(new Uri("ms-appx:///Assets/pokemons/ArticunoACG/Escudo.mp3"));
            mpSonidos.Play();
        }
        ...
        public void animacionDescasar()
        {
            ...
            auxiliar.Begin();
            mpSonidos.Source = MediaSource.CreateFromUri(new Uri("ms-appx:///Assets/pokemons/ArticunoACG/RecuperarVida.mp3"));
            mpSonidos.Play();
        }
        ...
        public void animacionDerrota()
        {
            ...
            auxiliar.Begin();
            mpSonidos.Source = MediaSource.CreateFromUri(new Uri("ms-appx:///Assets/pokemons/ArticunoACG/DerrotadoBien.mp3"));
            mpSonidos.Play();
        }
    }
}
