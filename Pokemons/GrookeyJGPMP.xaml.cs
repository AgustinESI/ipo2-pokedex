         ...
         private void ControlTeclas(object sender, KeyRoutedEventArgs e)
         {
             ...
             switch (e.Key)
             {
                 ...
                 case Windows.System.VirtualKey.Number1:
                     ...
                     sbaux.Begin();
                     mpSonidos.Source = MediaSource.CreateFromUri(new Uri("ms-appx:///Assets/pokemons/GrookeyJGPMP/AtaqueDebil.mp3"));
                     mpSonidos.Play();
                     break;
                 ...
                 case Windows.System.VirtualKey.Number2:
                     ...
                     sbaux.Begin();
                     mpSonidos.Source = MediaSource.CreateFromUri(new Uri("ms-appx:///Assets/pokemons/GrookeyJGPMP/AtaqueFuerte.mp3"));
                     mpSonidos.Play();
                     break;
                 ...
                 case Windows.System.VirtualKey.Number3:
                     ...
                     sbaux.Begin();
                     mpSonidos.Source = MediaSource.CreateFromUri(new Uri("ms-appx:///Assets/pokemons/GrookeyJGPMP/Escudo.mp4"));
                     mpSonidos.Play();
                     break;
                 ...
                 case Windows.System.VirtualKey.Number4:
                     ...
                     sbaux.Begin();
                     mpSonidos.Source = MediaSource.CreateFromUri(new Uri("ms-appx:///Assets/pokemons/GrookeyJGPMP/Descanso.mp3"));
                     mpSonidos.Play();
                     break;
                 ...
                 case Windows.System.VirtualKey.Q:
                     ...
                     sbaux.Begin();
                     mpSonidos.Source = MediaSource.CreateFromUri(new Uri("ms-appx:///Assets/pokemons/GrookeyJGPMP/Derrotado.mp3"));
                     mpSonidos.Play();
                     break;
